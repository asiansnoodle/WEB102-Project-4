...
This web app: An app which uses an API to get a random cat with a click of a button
...
link: https://imgur.com/a/szBgHHQ
...
Many challenges
getting the components to work together like getting data from one component to another was hard
